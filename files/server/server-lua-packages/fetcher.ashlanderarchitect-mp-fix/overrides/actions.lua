...
local function registerDefaultBindings(force)
    ...
    registerAction(knownActions.toggleBuildMode, "Toggle Build Mode", input.KEY.L, input.CONTROLLER_BUTTON.Back)
    ...
    registerAction(knownActions.resetRotation, "Reset Rotation", input.KEY.H, input.CONTROLLER_BUTTON.LeftStick)
